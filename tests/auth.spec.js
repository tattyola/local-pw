...
test.describe('Authentication & Authorization', () => {
  ...
  test('Sign in with existing credentials', async ({ dashboardPage, loginPage }) => {
  ...
  test('Sign in with wrong credentials', async ({ dashboardPage, loginPage }) => {
    ...
    await expect(dashboardPage.avatar).not.toBeVisible()
  })
})
